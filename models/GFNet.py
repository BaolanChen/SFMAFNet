...
class GFNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 in_chans=3,
                 num_classes=1000,
                 embed_dim=768, # 固定的embedding_size
                 depth=12,
...
if __name__ == '__main__':
    ...
    print("hello")
    # gfnet_h_s = GFNetPyramid(num_classes=10)
    gfnet_h_s = GFNetPyramid(
        img_size=224,
        patch_size=4,
        embed_dim=[96, 192, 384, 768],
        depth=[3, 3, 10, 3],
    ...
    gfnet_checkpoint_path = 'D:/PythonProject/RS_image_scene_classification/SKAL/checkpoints/gfnet-h-s.pth'
    checkpoint = torch.load(gfnet_checkpoint_path, map_location="cpu")
    gfnet_h_s.load_state_dict(checkpoint["model"])
    ...
    flops, params = profile(gfnet_h_s, inputs=(inputs,))
    print(f"gfnet_h_s Total FLOPs: {flops / 1e9} GFLOPs")
    print(f"gfnet_h_s Total Parameters: {params / 1e6} MParams")
